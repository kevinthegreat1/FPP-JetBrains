...
public interface FPPTypes {
  ...
  IElementType QUALIFIED_IDENTIFIER_COMPONENT_INSTANCE_DEFINITION_QUALIFIER = new FPPElementType("QUALIFIED_IDENTIFIER_COMPONENT_INSTANCE_DEFINITION_QUALIFIER");
  IElementType QUALIFIED_IDENTIFIER_CONSTANT_DEFINITION = new FPPElementType("QUALIFIED_IDENTIFIER_CONSTANT_DEFINITION");
  IElementType QUALIFIED_IDENTIFIER_CONSTANT_OR_ENUM_CONSTANT_DEFINITION = new FPPElementType("QUALIFIED_IDENTIFIER_CONSTANT_OR_ENUM_CONSTANT_DEFINITION");
  ...
  IElementType QUALIFIED_IDENTIFIER_QUALIFIER = new FPPElementType("QUALIFIED_IDENTIFIER_QUALIFIER");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == QUALIFIED_IDENTIFIER_COMPONENT_INSTANCE_DEFINITION_QUALIFIER) {
        return new FPPQualifiedIdentifierComponentInstanceDefinitionQualifierImpl(node);
      }
      else if (type == QUALIFIED_IDENTIFIER_CONSTANT_DEFINITION) {
        return new FPPQualifiedIdentifierConstantDefinitionImpl(node);
      }
      else if (type == QUALIFIED_IDENTIFIER_CONSTANT_OR_ENUM_CONSTANT_DEFINITION) {
        return new FPPQualifiedIdentifierConstantOrEnumConstantDefinitionImpl(node);
      }
      ...
      else if (type == QUALIFIED_IDENTIFIER_QUALIFIER) {
        return new FPPQualifiedIdentifierQualifierImpl(node);
      }
