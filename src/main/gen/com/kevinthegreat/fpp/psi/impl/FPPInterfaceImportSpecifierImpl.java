...
public class FPPInterfaceImportSpecifierImpl extends ASTWrapperPsiElement implements FPPInterfaceImportSpecifier {

  public FPPInterfaceImportSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitInterfaceImportSpecifier(this);
  }
