...
public class FPPQualifiedIdentifierImpl extends ASTWrapperPsiElement implements FPPQualifiedIdentifier {

  public FPPQualifiedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
