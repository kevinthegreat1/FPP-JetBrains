...
public class FPPArrayElementSequenceImpl extends ASTWrapperPsiElement implements FPPArrayElementSequence {

  public FPPArrayElementSequenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitArrayElementSequence(this);
  }
