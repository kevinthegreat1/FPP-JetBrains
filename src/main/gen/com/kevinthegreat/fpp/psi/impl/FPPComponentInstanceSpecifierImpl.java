...
public class FPPComponentInstanceSpecifierImpl extends ASTWrapperPsiElement implements FPPComponentInstanceSpecifier {

  public FPPComponentInstanceSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitComponentInstanceSpecifier(this);
  }
