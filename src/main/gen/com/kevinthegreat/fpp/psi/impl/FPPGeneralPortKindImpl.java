...
public class FPPGeneralPortKindImpl extends ASTWrapperPsiElement implements FPPGeneralPortKind {

  public FPPGeneralPortKindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitGeneralPortKind(this);
  }
