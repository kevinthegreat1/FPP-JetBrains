...
public class FPPTopologyMemberImpl extends ASTWrapperPsiElement implements FPPTopologyMember {

  public FPPTopologyMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTopologyMember(this);
  }
