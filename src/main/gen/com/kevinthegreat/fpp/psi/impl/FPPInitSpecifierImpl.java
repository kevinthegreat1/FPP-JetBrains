...
public class FPPInitSpecifierImpl extends ASTWrapperPsiElement implements FPPInitSpecifier {

  public FPPInitSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitInitSpecifier(this);
  }
