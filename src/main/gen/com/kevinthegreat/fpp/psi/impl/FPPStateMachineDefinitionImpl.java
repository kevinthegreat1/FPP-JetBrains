...
public class FPPStateMachineDefinitionImpl extends FPPNamedElementImpl implements FPPStateMachineDefinition {

  public FPPStateMachineDefinitionImpl(ASTNode node) {
    super(node);
  }
