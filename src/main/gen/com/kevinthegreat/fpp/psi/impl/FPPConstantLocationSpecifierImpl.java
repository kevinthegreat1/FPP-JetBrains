...
public class FPPConstantLocationSpecifierImpl extends ASTWrapperPsiElement implements FPPConstantLocationSpecifier {

  public FPPConstantLocationSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitConstantLocationSpecifier(this);
  }
