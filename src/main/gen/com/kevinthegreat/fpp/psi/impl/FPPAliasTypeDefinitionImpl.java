...
public class FPPAliasTypeDefinitionImpl extends ASTWrapperPsiElement implements FPPAliasTypeDefinition {

  public FPPAliasTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
