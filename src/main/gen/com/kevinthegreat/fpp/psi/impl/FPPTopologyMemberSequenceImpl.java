...
public class FPPTopologyMemberSequenceImpl extends ASTWrapperPsiElement implements FPPTopologyMemberSequence {

  public FPPTopologyMemberSequenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTopologyMemberSequence(this);
  }
