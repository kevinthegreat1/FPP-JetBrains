...
public class FPPInstanceSequenceImpl extends ASTWrapperPsiElement implements FPPInstanceSequence {

  public FPPInstanceSequenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitInstanceSequence(this);
  }
