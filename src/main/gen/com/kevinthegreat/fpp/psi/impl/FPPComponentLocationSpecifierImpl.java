...
public class FPPComponentLocationSpecifierImpl extends ASTWrapperPsiElement implements FPPComponentLocationSpecifier {

  public FPPComponentLocationSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitComponentLocationSpecifier(this);
  }
