...
public class FPPStateMachineLocationSpecifierImpl extends ASTWrapperPsiElement implements FPPStateMachineLocationSpecifier {

  public FPPStateMachineLocationSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitStateMachineLocationSpecifier(this);
  }
