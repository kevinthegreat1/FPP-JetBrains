...
public class FPPQueueFullBehaviorImpl extends ASTWrapperPsiElement implements FPPQueueFullBehavior {

  public FPPQueueFullBehaviorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitQueueFullBehavior(this);
  }
