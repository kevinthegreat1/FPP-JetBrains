...
public class FPPPortInstanceIdentifierImpl extends ASTWrapperPsiElement implements FPPPortInstanceIdentifier {

  public FPPPortInstanceIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
