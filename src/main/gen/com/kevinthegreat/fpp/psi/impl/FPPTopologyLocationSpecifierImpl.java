...
public class FPPTopologyLocationSpecifierImpl extends ASTWrapperPsiElement implements FPPTopologyLocationSpecifier {

  public FPPTopologyLocationSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTopologyLocationSpecifier(this);
  }
