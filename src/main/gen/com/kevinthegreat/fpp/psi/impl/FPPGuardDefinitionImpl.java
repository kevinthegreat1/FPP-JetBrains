...
public class FPPGuardDefinitionImpl extends ASTWrapperPsiElement implements FPPGuardDefinition {

  public FPPGuardDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitGuardDefinition(this);
  }
