...
public class FPPCommandKindImpl extends ASTWrapperPsiElement implements FPPCommandKind {

  public FPPCommandKindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitCommandKind(this);
  }
