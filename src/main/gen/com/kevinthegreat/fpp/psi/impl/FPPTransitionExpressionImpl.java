...
public class FPPTransitionExpressionImpl extends ASTWrapperPsiElement implements FPPTransitionExpression {

  public FPPTransitionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTransitionExpression(this);
  }
