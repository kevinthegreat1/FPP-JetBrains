...
public class FPPTelemetryPacketGroupMemberSequenceImpl extends ASTWrapperPsiElement implements FPPTelemetryPacketGroupMemberSequence {

  public FPPTelemetryPacketGroupMemberSequenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTelemetryPacketGroupMemberSequence(this);
  }
