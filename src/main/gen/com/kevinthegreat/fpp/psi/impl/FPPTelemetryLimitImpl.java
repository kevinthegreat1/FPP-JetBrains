...
public class FPPTelemetryLimitImpl extends ASTWrapperPsiElement implements FPPTelemetryLimit {

  public FPPTelemetryLimitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitTelemetryLimit(this);
  }
  ...
  public FPPExpression getExpression() {
    return findNotNullChildByClass(FPPExpression.class);
  }
