...
public class FPPActionSequenceImpl extends ASTWrapperPsiElement implements FPPActionSequence {

  public FPPActionSequenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FPPVisitor visitor) {
    visitor.visitActionSequence(this);
  }
