...
public class FPPParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // qualified_identifier_component_instance_definition_qualifier DOT IDENTIFIER
  public static boolean port_instance_identifier(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = qualified_identifier_component_instance_definition_qualifier(builder_, level_ + 1);
    result_ = result_ && consumeTokens(builder_, 0, DOT, IDENTIFIER);
  ...
  /* ********************************************************** */
  // qualified_identifier_qualifier
  public static boolean qualified_identifier_component_instance_definition_qualifier(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_component_instance_definition_qualifier")) return false;
    if (!nextTokenIs(builder_, IDENTIFIER)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = qualified_identifier_qualifier(builder_, level_ + 1);
    exit_section_(builder_, marker_, QUALIFIED_IDENTIFIER_COMPONENT_INSTANCE_DEFINITION_QUALIFIER, result_);
    return result_;
  }
  ...
  public static boolean qualified_identifier_qualifier(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_qualifier")) return false;
    if (!nextTokenIs(builder_, IDENTIFIER)) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, IDENTIFIER);
    result_ = result_ && qualified_identifier_qualifier_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, QUALIFIED_IDENTIFIER_QUALIFIER, result_);
    return result_;
  }

  // (DOT IDENTIFIER &(DOT IDENTIFIER))*
  private static boolean qualified_identifier_qualifier_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_qualifier_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!qualified_identifier_qualifier_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "qualified_identifier_qualifier_1", pos_)) break;
    }
    return true;
  }

  // DOT IDENTIFIER &(DOT IDENTIFIER)
  private static boolean qualified_identifier_qualifier_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_qualifier_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, DOT, IDENTIFIER);
    result_ = result_ && qualified_identifier_qualifier_1_0_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // &(DOT IDENTIFIER)
  private static boolean qualified_identifier_qualifier_1_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_qualifier_1_0_2")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = qualified_identifier_qualifier_1_0_2_0(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // DOT IDENTIFIER
  private static boolean qualified_identifier_qualifier_1_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "qualified_identifier_qualifier_1_0_2_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeTokens(builder_, 0, DOT, IDENTIFIER);
    exit_section_(builder_, marker_, null, result_);
